...
inherit autotools bash-completion-r1 db-use depend.apache old-distutils-r1 flag-o-matic java-pkg-opt-2 libtool multilib perl-module ruby-single toolchain-funcs xdg-utils
