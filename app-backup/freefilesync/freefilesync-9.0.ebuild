...
SRC_URI="http://download1223.mediafire.com/g078q7ht1n9g/45pm1xvi9ije1pc/FreeFileSync_9.0_Source.zip http://www.freefilesync.org/download/FreeFileSync_${PV}_Source.zip"
RESTRICT="primaryuri"
LICENSE="GPL-3"
...
src_prepare(){
    ...
    epatch "${FILESDIR}"/freefilesync-9.0-materialize-function.patch
}
