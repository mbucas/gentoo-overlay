...
SRC_URI="http://download1394.mediafireuserdownload.com/dgbcipis86jg/p3aiica01n7efcw/FreeFileSync_9.1_Source.zip http://www.freefilesync.org/download/FreeFileSync_${PV}_Source.zip"
RESTRICT="primaryuri"
LICENSE="GPL-3"
...
src_prepare(){
    ...
    epatch "${FILESDIR}"/freefilesync-9.1-materialize-function.patch
}
