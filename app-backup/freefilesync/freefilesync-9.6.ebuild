...
# Automatic download restricted, add a user agent to wget
# FETCHCOMMAND="wget -U Mozilla -t 3 -T 60 --passive-ftp -O \"\${DISTDIR}/\${FILE}\" \"\${URI}\""
...
src_prepare(){
    ...
    epatch "${FILESDIR}"/freefilesync-${PV}-materialize-function.patch
}
